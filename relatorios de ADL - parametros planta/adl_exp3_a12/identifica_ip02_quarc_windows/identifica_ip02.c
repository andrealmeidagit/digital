...
void identifica_ip02_initialize(boolean_T firstTime)
{
  ...
  rtmSetTFinal(identifica_ip02_M, 10.0);
  identifica_ip02_M->Timing.stepSize0 = 0.001;
  identifica_ip02_M->Timing.stepSize1 = 0.001;

  /* external mode info */
  identifica_ip02_M->Sizes.checksums[0] = (2656381553U);
  identifica_ip02_M->Sizes.checksums[1] = (3728800456U);
  identifica_ip02_M->Sizes.checksums[2] = (117563897U);
  identifica_ip02_M->Sizes.checksums[3] = (2982113954U);
