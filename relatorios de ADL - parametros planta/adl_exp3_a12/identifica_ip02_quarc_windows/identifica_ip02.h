 ...
 * C source code generated on : Mon Oct 01 09:39:38 2018
 */
...
typedef struct {
  ...
  real_T VelocidadeparaPosio;          /* '<S2>/Velocidade  para Posição' */
  real_T mtomm_m;                      /* '<Root>/m to mm  ' */
  real_T IP02ModeloExperimental;       /* '<Root>/IP02 Modelo Experimental' */
  real_T SwitchControl;                /* '<S4>/SwitchControl' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T Kp1;                          /* '<Root>/Kp1' */
  real_T AmplifierVoltageSaturation;   /* '<Root>/Amplifier Voltage Saturation' */
  real_T SwitchControl_d;              /* '<S3>/SwitchControl' */
  real_T AmplifierVoltageSaturation1;  /* '<Root>/Amplifier Voltage Saturation1' */
  real_T AceleraoparaVelocidade;       /* '<S2>/Aceleração para Velocidade' */
  real_T Amortecimentoviscoso;         /* '<S2>/Amortecimento viscoso' */
  real_T BackEMF1;                     /* '<S2>/Back EMF1' */
  real_T ForaContraeletromotriz;       /* '<S2>/Força Contra-eletromotriz' */
  real_T Sum;                          /* '<S2>/Sum' */
  real_T TensoparaCorrente;            /* '<S2>/Tensão para Corrente' */
  real_T SaturaoparaCorrente;          /* '<S2>/Saturação para Corrente' */
  real_T CorrenteparaFora;             /* '<S2>/Corrente para Força' */
  real_T Sum1;                         /* '<S2>/Sum1' */
  real_T Inercias;                     /* '<S2>/Inercias' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ToWorkspaceModeloTeorico_PWORK;    /* '<Root>/To Workspace Modelo Teorico' */
...
typedef struct {
  real_T VelocidadeparaPosio_CSTATE;   /* '<S2>/Velocidade  para Posição' */
  real_T IP02ModeloExperimental_CSTATE[2];/* '<Root>/IP02 Modelo Experimental' */
  real_T AceleraoparaVelocidade_CSTATE;/* '<S2>/Aceleração para Velocidade' */
...
/* State disabled  */
typedef struct {
  boolean_T VelocidadeparaPosio_CSTATE;/* '<S2>/Velocidade  para Posição' */
  boolean_T IP02ModeloExperimental_CSTATE[2];/* '<Root>/IP02 Modelo Experimental' */
  boolean_T AceleraoparaVelocidade_CSTATE;/* '<S2>/Aceleração para Velocidade' */
...
struct Parameters_identifica_ip02_ {
  ...
  real_T mtomm_Gain_f;                 /* Expression: 1e3
                                        * '<Root>/m to mm '
                                        */
  real_T VelocidadeparaPosio_IC;       /* Expression: 0
                                        * '<S2>/Velocidade  para Posição'
                                        */
  real_T mtomm_Gain_b;                 /* Expression: 1e3
                                        * '<Root>/m to mm  '
                                        */
  real_T IP02ModeloExperimental_A[2];  /* Computed Parameter: A
                                        * '<Root>/IP02 Modelo Experimental'
                                        */
  real_T IP02ModeloExperimental_C[2];  /* Computed Parameter: C
                                        * '<Root>/IP02 Modelo Experimental'
                                        */
  real_T Kp1_Gain;                     /* Expression: 420
                                        * '<Root>/Kp1'
                                        */
  real_T AmplifierVoltageSaturation_Uppe;/* Expression: VMAX_AMP
                                          * '<Root>/Amplifier Voltage Saturation'
                                          */
  real_T AmplifierVoltageSaturation_Lowe;/* Expression: - VMAX_AMP
                                          * '<Root>/Amplifier Voltage Saturation'
                                          */
  ...
  real_T AmplifierVoltageSaturation1_Low;/* Expression: - VMAX_AMP
                                          * '<Root>/Amplifier Voltage Saturation1'
                                          */
  real_T AceleraoparaVelocidade_IC;    /* Expression: 0
                                        * '<S2>/Aceleração para Velocidade'
                                        */
  real_T Amortecimentoviscoso_Gain;    /* Expression: Beq
                                        * '<S2>/Amortecimento viscoso'
                                        */
  real_T BackEMF1_Gain;                /* Expression: Kg/r_mp
                                        * '<S2>/Back EMF1'
                                        */
  real_T ForaContraeletromotriz_Gain;  /* Expression: Km
                                        * '<S2>/Força Contra-eletromotriz'
                                        */
  real_T TensoparaCorrente_Gain;       /* Expression: 1/Rm
                                        * '<S2>/Tensão para Corrente'
                                        */
  real_T SaturaoparaCorrente_UpperSat; /* Expression: IMAX_AMP
                                        * '<S2>/Saturação para Corrente'
                                        */
  real_T SaturaoparaCorrente_LowerSat; /* Expression: - IMAX_AMP
                                        * '<S2>/Saturação para Corrente'
                                        */
  real_T CorrenteparaFora_Gain;        /* Expression: Eff_g*Kg*Eff_m*Kt/r_mp
                                        * '<S2>/Corrente para Força'
                                        */
  real_T Inercias_Gain;                /* Expression: 1/(M+Eff_g*Kg^2*Jm/r_mp^2)
                                        * '<S2>/Inercias'
                                        */
 ...
 * '<S2>'   : identifica_ip02/IP02 Modelo Teorico
