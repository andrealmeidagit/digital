...
void identifica_ip02_output(int_T tid)
{
...

  {
    ...
    identifica_ip02_B.Integrator = identifica_ip02_X.Integrator_CSTATE;

    /* Gain: '<Root>/m to mm  1' */
    identifica_ip02_B.mtomm1 = identifica_ip02_P.mtomm1_Gain *
      identifica_ip02_B.Integrator;
    if (rtmIsMajorTimeStep(identifica_ip02_M) &&
        identifica_ip02_M->Timing.TaskCounters.TID[1] == 0) {
    }
    ...
    /* Gain: '<Root>/Kp2' */
    identifica_ip02_B.Kp2 = identifica_ip02_P.Kp2_Gain * identifica_ip02_B.Sum1;

    /* Saturate: '<Root>/Amplifier Voltage Saturation1' */
    riseValLimit = identifica_ip02_B.Kp2;
    ...
    /* ZeroPole Block: '<S2>/Zero-Pole' */
    {
      identifica_ip02_B.ZeroPole = identifica_ip02_P.ZeroPole_C*
        identifica_ip02_X.ZeroPole_CSTATE;
    }
  }
...
void identifica_ip02_derivatives(void)
{
  ...
  ((StateDerivatives_identifica_ip0 *) identifica_ip02_M->ModelData.derivs)
    ->Integrator_CSTATE = identifica_ip02_B.ZeroPole;

  /* ZeroPole Block: '<S2>/Zero-Pole' */
  {
    ((StateDerivatives_identifica_ip0 *) identifica_ip02_M->ModelData.derivs)
      ->ZeroPole_CSTATE = identifica_ip02_B.AmplifierVoltageSaturation1;
    ((StateDerivatives_identifica_ip0 *) identifica_ip02_M->ModelData.derivs)
      ->ZeroPole_CSTATE += (identifica_ip02_P.ZeroPole_A)*
      identifica_ip02_X.ZeroPole_CSTATE;
  }
}
...
void identifica_ip02_initialize(boolean_T firstTime)
{
  ...
  rtmSetTFinal(identifica_ip02_M, 2.0);
  identifica_ip02_M->Timing.stepSize0 = 0.001;
  identifica_ip02_M->Timing.stepSize1 = 0.001;

  /* external mode info */
  identifica_ip02_M->Sizes.checksums[0] = (684548362U);
  identifica_ip02_M->Sizes.checksums[1] = (588252108U);
  identifica_ip02_M->Sizes.checksums[2] = (982741228U);
  identifica_ip02_M->Sizes.checksums[3] = (1298898378U);
...

  {
    ...
    identifica_ip02_B.Integrator = 0.0;
    identifica_ip02_B.mtomm1 = 0.0;
    identifica_ip02_B.SwitchControl = 0.0;
    identifica_ip02_B.Sum1 = 0.0;
    identifica_ip02_B.Kp2 = 0.0;
    identifica_ip02_B.AmplifierVoltageSaturation1 = 0.0;
    identifica_ip02_B.ZeroPole = 0.0;
    identifica_ip02_B.CheckMaximumAllowedPosition = 0.0;
    identifica_ip02_B.CheckMinimumAllowedPosition = 0.0;
...
{
  identifica_ip02_M->Sizes.numContStates = (2);/* Number of continuous states */
  ...
  identifica_ip02_M->Sizes.numBlocks = (56);/* Number of blocks */
  identifica_ip02_M->Sizes.numBlockIO = (36);/* Number of block outputs */
  identifica_ip02_M->Sizes.numBlockPrms = (158);/* Sum of parameter "widths" */
}
...
void MdlInitialize(void)
{
  ...
  identifica_ip02_X.Integrator_CSTATE = identifica_ip02_P.Integrator_IC;

  /* ZeroPole Block: '<S2>/Zero-Pole' */
  identifica_ip02_X.ZeroPole_CSTATE = 0.0;
}
